...
def sorting(path):
    ...
    for file in path.iterdir():
        ...
        if suf in suf_dict['img']:
            ...
            new_file_path = str(path_grbg) + r"\images\\" + new_file_name
        elif suf in suf_dict['doc']:
            files_dict['doc'].append(new_file_name)
            inc_suf.append(suf) if not suf in inc_suf else ...
            new_file_path = str(path_grbg) + r"\documents\\" + new_file_name
        elif suf in suf_dict['mus']:
            files_dict['mus'].append(new_file_name)
            inc_suf.append(suf) if not suf in inc_suf else ...
            new_file_path = str(path_grbg) + r"\audio\\" + new_file_name
        elif suf in suf_dict['vid']:
            files_dict['vid'].append(new_file_name)
            inc_suf.append(suf) if not suf in inc_suf else ...
            new_file_path = str(path_grbg) + r"\video\\" + new_file_name
        elif suf in suf_dict['arch']:
            files_dict['arch'].append(new_file_name)
            inc_suf.append(suf) if not suf in inc_suf else ...
            new_file_path = str(path_grbg) + r"\archives\\" + new_file_name[:-(len(suf))]
            ...
            new_file_path = str(path_grbg) + r"\other\\" + new_file_name
